...
namespace Tusa_Alexandra_Teodora_Lab2.Data
{
    public class Tusa_Alexandra_Teodora_Lab2Context : DbContext
    {
        ...
        public DbSet<Tusa_Alexandra_Teodora_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Tusa_Alexandra_Teodora_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Tusa_Alexandra_Teodora_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
