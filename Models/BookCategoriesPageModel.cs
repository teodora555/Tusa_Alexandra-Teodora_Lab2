...
namespace Tusa_Alexandra_Teodora_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Tusa_Alexandra_Teodora_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Tusa_Alexandra_Teodora_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
